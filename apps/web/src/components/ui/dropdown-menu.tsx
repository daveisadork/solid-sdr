  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        class={cn(
          "z-50 min-w-32 max-h-(--kb-popper-content-available-height) origin-(--kb-menu-content-transform-origin) animate-content-hide overflow-auto rounded-md border fancy-bg-popover p-1 text-popover-foreground shadow-md data-expanded:animate-content-show",
          props.class,
        )}
        {...rest}
      />
